...
const sendEmail = (
    ...
    avgVolatility
        ...
        const mailOptions = {
            ...
            subject: `Binance monitor: Change: ${changeSign}${priceChange.toFixed(2)}%. Avg Volatility: ${avgVolatility.toFixed(2)}%. Duration: ${parseInt((endTime - startTime) / 1000 / 60)} mins. Interval: ${parseInt(process.env.FRAME_INTERVAL || 5)} mins.`,
...
Monitoring opening Price: $${openingPrice.toFixed(2)}.
-----------------------------------------
...
-----------------------------------------
Monitoring closing Price: $${closingPrice.toFixed(2)}.`
        };
        // Send the email
