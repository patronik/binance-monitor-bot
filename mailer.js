...
const sendEmail = (
    ...
    avgVolatility
        ...
        const mailOptions = {
            ...
            subject: `Binance monitor: Avg Volatility: ${avgVolatility.toFixed(2)}%. Duration: ${((endTime - startTime) / 1000 / 60)} minutes. Interval: ${(process.env.FRAME_INTERVAL || 5)} minutes.`,
